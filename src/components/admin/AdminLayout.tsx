...
const defaultSections = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "brands", to: "/admin/brands", label: "Marcas", icon: Award },
  ...
  },
  {
    ...
    label: "Asistente IA",
    items: [
      { key: "agente-catalogo", to: "/admin/agente-catalogo", label: "Agente IA · Administración", icon: Sparkles },
...
const titleFromPath = (p: string, labels: Record<string, string>) => {
  ...
  if (p.startsWith("/admin/agente-catalogo")) return get("agente-catalogo", "Agente IA · Administración");
