...
export const THEME_PRESETS: ThemePreset[] = [
  ...
  mkPreset(
    "nutribatidos-verde-natural",
    "Nutribatidos Verde Natural",
    "Verde saludable, moderno y comercial con tipografía limpia tipo iHerb.",
    ["#151515", "#35A936", "#1F7A2E", "#A8E6A1", "#EAF8E8"],
    "Inter",
    "Inter",
    {
      background: "0 0% 100%",
