...
const D = {
  about_eyebrow: "Sobre Voltra",
  about_title_line1: "Creado por atletas.",
  about_title_line2: "Para todos",
  about_title_line3: "los que no se conforman.",
  about_story_title: "Nuestra historia",
  about_story_p1: "Voltra nació en un gimnasio de garaje en 2019.",
  about_story_p2: "Hoy, atletas de todo el mundo confían en nosotros.",
  about_stat1_n: "240k+", about_stat1_l: "Atletas",
  about_stat2_n: "38", about_stat2_l: "Países",
  about_stat3_n: "4.9★", about_stat3_l: "Valoración media",
  about_stat4_n: "100%", about_stat4_l: "Probado en laboratorio",
  about_principles_title: "Nuestros principios",
  about_principle1_t: "Ciencia primero", about_principle1_d: "Respaldado por investigación.",
  about_principle2_t: "Etiquetas limpias", about_principle2_d: "Sin rellenos.",
  about_principle3_t: "Verificado en laboratorio", about_principle3_d: "Probado de forma independiente.",
  about_principle4_t: "Obsesionados con el atleta", about_principle4_d: "Escuchamos.",
  about_cta_title: "¿Listo para impulsar tus objetivos?",
  about_cta_label: "Comprar el catálogo",
  about_cta_href: "/",
};

const ICONS = [FlaskConical, Leaf, Award, Heart];
    ...
    <Layout>
      <section className="relative overflow-hidden bg-surface-darker text-background">
        ...
        <div className="container-x relative py-24 lg:py-32">
          <span className="text-xs font-bold uppercase tracking-[0.3em] text-accent">{c.about_eyebrow}</span>
          <h1 className="mt-4 max-w-3xl font-display text-5xl uppercase leading-tight sm:text-6xl lg:text-7xl">
      ...
      <section className="container-x grid gap-12 py-16 lg:grid-cols-2 lg:items-center">
        <div>
          <h2 className="font-display text-3xl uppercase sm:text-4xl">{c.about_story_title}</h2>
      ...
      <section className="bg-secondary/40 py-16">
        <div className="container-x">
          <h2 className="font-display text-3xl uppercase sm:text-4xl">{c.about_principles_title}</h2>
      ...
      <section className="container-x py-16 text-center">
        <h2 className="font-display text-3xl uppercase sm:text-4xl">{c.about_cta_title}</h2>
