...
const D = {
  about_eyebrow: "About Voltra",
  about_title_line1: "Built by athletes.",
  about_title_line2: "For everyone",
  about_title_line3: "who refuses to settle.",
  about_story_title: "Our story",
  about_story_p1: "Voltra was born in a garage gym in 2019.",
  about_story_p2: "Today, athletes from all over the world trust us.",
  about_stat1_n: "240k+", about_stat1_l: "Athletes",
  about_stat2_n: "38", about_stat2_l: "Countries",
  about_stat3_n: "4.9★", about_stat3_l: "Avg rating",
  about_stat4_n: "100%", about_stat4_l: "Lab tested",
  about_principles_title: "Our principles",
  about_principle1_t: "Science first", about_principle1_d: "Backed by research.",
  about_principle2_t: "Clean labels", about_principle2_d: "No fillers.",
  about_principle3_t: "Lab verified", about_principle3_d: "Independently tested.",
  about_principle4_t: "Athlete obsessed", about_principle4_d: "We listen.",
  about_cta_title: "Ready to fuel your goals?",
  about_cta_label: "Shop the range",
  about_cta_href: "/",
};
