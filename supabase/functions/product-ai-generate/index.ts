  ...
  function: {
    ...
    parameters: {
      ...
      properties: {
        ...
        seo_title: { type: "string", description: "Meta title <= 60 caracteres." },
        seo_description: { type: "string", description: "Meta description <= 160 caracteres." },
        seo_keywords: {
          type: "array",
          description: "5-10 keywords/frases SEO en español, sin almohadillas.",
          items: { type: "string" },
        },
      },
