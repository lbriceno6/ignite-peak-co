...
const BACKGROUND_PROMPTS: Record<string, string> = {
  white_ecommerce:
    "Place the product on a clean, pure white seamless ecommerce background. Even soft studio lighting, subtle natural shadow under the product, centered composition, crisp edges. No props, no text added, no extra objects.",
  transparent:
    "Place the product on a solid pure white background so the background can be removed cleanly. No shadows touching edges, crisp clean cutout edges. Do not add any objects or text.",
  premium_jar:
    "Place the product on an elegant dark premium background, professional studio lighting with soft rim light, realistic contact shadow and subtle reflection on a dark glossy surface, ideal for jars and bottles. Cinematic, luxury catalog look. No added text or props.",
  premium_box:
    "Place the product on an elegant dark premium background, professional studio lighting, soft realistic shadow and gentle reflection on a dark surface, ideal for boxes and packaging. Cinematic, luxury catalog look. No added text or props.",
};
